...
const DEFAULT_CONTEXT_MAP: ContextMap = {
...
const DEFAULT_FRICTION_RULES: FrictionRules = {
...
const DEFAULT_MODE_RULES: ModeRules = {
  'morning-triage': {
...
export function getDefaultData(): OntologyData {
  return {
    ...
    contextMap: JSON.parse(JSON.stringify(DEFAULT_CONTEXT_MAP)) as ContextMap,
    frictionRules: { ...DEFAULT_FRICTION_RULES },
    modeRules: JSON.parse(JSON.stringify(DEFAULT_MODE_RULES)) as ModeRules,
  }
}
